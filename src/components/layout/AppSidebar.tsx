...
const navigationItems: SidebarItem[] = [
  ...
  { title: "Invoice Generation", url: "/invoice-generation", icon: Calculator, permission: "billing" },
  { title: "Invoices & Payments", url: "/invoices", icon: FileText, permission: "invoices" },
